...
class CocoDataset():
    ...
    def display_image(self, image_id, show_polys=True, show_bbox=True, show_crowds=True, use_url=False):
        ...
        # print("xxx",type(self.images), len(self.images), self.images.keys())
...
annotation_path = '*/VOC2007/AnnotationsJson/voc2007_to_coco.json'
image_dir = '*dataset/VOC/VOCdevkit/VOC2007/JPEGImages'
...
# html = coco_dataset.display_image(823, use_url=False)
