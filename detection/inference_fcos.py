...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="configs/fcos/fcos_imprv_dcnv2_R_101_FPN_2x.yaml",
        metavar="FILE",
        help="path to config file",
    )
    parser.add_argument(
        "--weights",
        default="FCOS_imprv_dcnv2_R_101_FPN_2x.pth.pth",
        metavar="FILE",
    ...
    for im_name in demo_im_names:
        ...
        cv2.imwrite('/vdata/Synthesize/xcb/pred_{}'.format(im_name), composite)
