...
def evaluation(pred, gt_path, iou_thresh=0.5):
    ...
    """
    Easy   Val AP: 0.7106
    Medium Val AP: 0.6230
    Hard   Val AP: 0.4074
    # after transform 
    Easy   Val AP: 0.7197
    Medium Val AP: 0.6378
    Hard   Val AP: 0.4872
    # facebox:
    Easy   Val AP: 0.5830
    Medium Val AP: 0.4316
    Hard   Val AP: 0.1945
    """
    print("=================================================")
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--pred', default="/aidata/dataset/faces/face_detect/wider_face/WIDER/WIDER_val/Pred_txt_facebox/")
