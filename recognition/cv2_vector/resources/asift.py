...
if __name__ == '__main__':
    ...
    opts = dict(opts)
    '''
       --feature:  sift/surf/orb/akaze/brisk
       'surf', 'orb', 'akaze', 'brisk', 'freak'
    '''
    features = ['akaze']
    for f in features:
        feature_name = opts.get('--feature', '{}-flann'.format(f))
        try:
            fn1, fn2 = args
        except:
            fn1 = './data/BH_BZ_851_0_.png'
            fn2 = './data/BH_BZ_851_14_.png'
        ...
        match_and_draw('affine_find_obj_{}.jpg'.format(f))
